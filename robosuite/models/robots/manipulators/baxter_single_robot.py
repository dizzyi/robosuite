...
class BaxterSingle(ManipulatorModel):
    ...
    def default_gripper(self):
        ...
        Returns:
            ...
            {"right": "RethinkGripper",
            "left": "RethinkGripper"}

        Now only return one gripper
        """
    ...
    def default_controller_config(self):
        ...
        Returns:
            ...
            {"Right": "default_baxter",
            "Left": "default_baxter"}

        Now only return one controller
        """
        return "default_baxter"
    ...
    def init_qpos(self):
        ...
        Returns:
            ...
            np.array([0.403, -0.636, 0.114, 1.432, 0.735, 1.205, -0.269,
                        -0.403, -0.636, -0.114, 1.432, -0.735, 1.205, 0.269])
            # [right, left]
            # Arms half extended
        Now only return the right arm pose
        """
        # [right]
        # Arms half extended
    ...
    @property
    def arm_type(self):  # previpusly return "bimanual"
        return "single"